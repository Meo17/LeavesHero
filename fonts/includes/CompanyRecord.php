  ...
  <div class="row content">
    <div class="col-sm-2 sidenav hidden-xs" style="padding-top: 20px;position: fixed;">
      ...
      <ul class="nav nav-pills nav-stacked" style="padding-top: 30px">
         ...
         <li class="active"><a href="companyrecord.php?id=<?php echo $a["id"];?>" class="aqua-hover" style="padding-bottom: 3px;padding-top: 3px;padding-left: 36px"><span class="design icon_rep"></span>Subscriber</a></li>
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="well" style="height:auto;padding-bottom: 50px;height: 405px"> 
            ...
            <h5 style="float: left;"><b>List of subscribers</b></h5>
            ...
            <table class="table table-hover" style="table-layout: auto ;" >
              <thead>
                <tr>
                  ...
                  <th style="font-size: 12px">Subscription Date</th>
                  <th style="font-size: 12px">Monthly Payment</th>
          ...
          <?php foreach( $Billinginformation as $row){?>
            ...
            <tbody id="sub">
              ...
              <tr >
                ...
                <td style="font-size: 12px"><?php echo $row['Sub_Date']?></td>
