...
if (!isset($_SESSION['Username'])) {
    ...
    $query = "SELECT COUNT(*) as visits , LeaveType  FROM  apply_leave_request a  JOIN leave_type l on a.Company_Id = l.Company_Id JOIN company c ON c.Company_Id = a.Company_Id WHERE a.Leave_Type = l.LeaveType AND  a.Leave_Status = 'Approved' AND c.Username = '$user' GROUP BY Leave_Type";
