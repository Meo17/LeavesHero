...
<html lang="en">
<head>
  <title>SABillingPayPalPage</title>
    <meta charset="utf-8">
                     ...
                     <div class="container" style="width: 940px">
                        <div class="container" style="width: 935px">
                          ...
                          <ul class="resp-tabs-list" style="padding-left: 145px">
                              ...
                              <li class="resp-tab-item pay-tab active-tab" aria-controls="tab_item-0" role="tab"><a class="pay-tab" href="companybillingaccount.php" style="text-decoration: none"><span><label style="height:50px" class="pic1 "style="width:100px'margin-left"><i class="fa fa-credit-card"></i></label>Credit Card</span></a></li>

                              <li class="resp-tab-item resp-tab-active" aria-controls="tab_item-2" role="tab"><a class="pay-tab" href="Paypal.php" style="color:#00cc99;text-decoration: none"><span><label style="height:50px"class="pic4"><i class="fa fa-paypal"></i> <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/mdbootstrap/4.5.7/css/mdb.min.css" /></label>PayPal</span></a></li> 
                              <div class="clear"></div>
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="well" style="padding-bottom: 50px;height: 350px"> 
            <div style="width: 300px;border-right: 2px solid #ccc;padding-right: 40px;float:left">
            <form class="form" action="/action_page.php" style="padding-left: 60px;padding-top: 20px">
              <h5>Personal Information</h5>
                ...
                <div class="form-group"  style="padding-right: 10px">
                  <h6>Phone Number</h6>
                  <input type="text" class="form-control" id="pwd" placeholder="Phone Number">
                </div>
              </form>
            </div>
            <div style="width: 300px;border-right: 2px solid #ccc;padding-right: 40px;float:left">
            <form class="form" action="/action_page.php" style="padding-left: 60px;;padding-top: 20px">
              <h5>Address</h5>
                <div class="form-group" style="padding-right: 10px">
                  <h6>Full Address</h6>
                  <input type="text" class="form-control" id="email" placeholder="Full Address">
                </div>
                <div class="form-group"  style="padding-right: 10px">
                  <h6>Post Code</h6>
                  <input type="text" class="form-control" id="pwd" placeholder="Post Code">
                </div>
                <div class="form-group"  style="padding-right: 10px">
                  <h6>Country</h6>
                  <input type="text" class="form-control" id="pwd" placeholder="Country">
                </div>
              </form>
            </div>
            ...
            <form class="form" action="/action_page.php" style="padding-left: 60px;padding-top: 20px">
              <h5>Credit Card Information</h5>
                <div class="form-group" style="padding-right: 10px">
                  <h6>Name on Card</h6>
                  <input type="text" class="form-control" id="email" placeholder="Name on Card">
                </div>
                <div class="form-group"  style="padding-right: 10px">
                  <h6>Card Number</h6>
                  <input type="text" class="form-control" id="pwd" placeholder="Card Number">
                </div>
                <div>
                <div class="form-group"  style="padding-right: 10px;float: left;">
                  <h6>Expiration</h6>
                  <input type="date" class="form-control" id="pwd" style="width:131px">
                </div>
                <div class="form-group"  style="padding-right: 10px;float: right;">
                  <h6>CVV Number</h6>
                  <input type="Number" class="form-control" id="pwd" placeholder="XXXX" style="width:65px">
                </div>
                </div>
              </form>
            </div>
            <div style="width: 550px;padding-left: 62px;">
              <button type="button" class="btn btn-gray btn-hover-lightgray btn-sm" style="width: 62px;line-height: 1">Submit</button>
              <div class="checkbox">
                <label>
                  <input type="checkbox" value="">By checking this box, I agree to the Terms & Conditions & Privacy Policy.
                </label>
              </div>
            </div>
          </div>
