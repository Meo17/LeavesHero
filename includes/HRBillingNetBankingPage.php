...
<html lang="en">
<head>
  <title>HRBillingNetBankingPage</title>
    <meta charset="utf-8">
    ...
    <div class="col-sm-10" style="float: right;background-color: #f1f1f1">
      <div class="container" style="border-bottom: 2px solid #00cc99; height: 30px;float: left;width: 954px">
        ...
        <div class="dropdown" style="float: right;top:-13px;">
          ...
          <button class="btn btn-white lightgray-hover dropdown-toggle" type="button" data-toggle="dropdown" style="font-size: 12px; font-family:'Roboto';"><?php echo $u['Company_Name']; ?>
              <?php }?> 
                        ...
                        <div class="container" style="width: 935px">
                          ...
                          <ul class="resp-tabs-list" style="padding-left: 145px">
                              ...
                              <li class="resp-tab-item resp-tab-active " aria-controls="tab_item-1" role="tab">
                                <a class="pay-tab" href="HRBillingNetBankingPage.php" style="color:#00cc99;text-decoration: none"><span><label style="height:50px"class="pic3"></label>Net Banking</span></a></li>
                              ...
                              <li class="resp-tab-item pay-tab active-tab" aria-controls="tab_item-3" role="tab"><a class="pay-tab" href="DebitCard.php" style="text-decoration: none"><span><label style="height:50px"class="pic2"></label>Debit Card</span></a></li>
                              <div class="clear"></div>
          ...
          <div class="well" style="padding-bottom: 50px;height: 350px"> 
            ...
            <form class="form" action="/action_page.php" style="padding-left: 60px;padding-top: 20px">
              <h5>Credit Card Information</h5>
                <div class="form-group" style="padding-right: 10px">
                  <h6>Name on Card</h6>
                  <input type="text" class="form-control"  placeholder="Name on Card" name="namecard">
                </div>
                <div class="form-group"  style="padding-right: 10px">
                  <h6>Card Number</h6>
                  <input type="text" class="form-control" id="pwd" placeholder="Card Number" name="cardnumber">
                </div>
                <div>
                <div class="form-group"  style="padding-right: 10px;float: left;">
                  <h6>Expiration</h6>
                  <input type="date" class="form-control" id="pwd" style="width:131px" name="expiration">
                </div>
                <div class="form-group"  style="padding-right: 10px;float: right;">
                  <h6>CVV Number</h6>
                  <input type="Number" class="form-control" id="pwd" placeholder="XXXX" style="width:65px" name="cvvnumber">
                </div>
                </div>
             
            </div>
            <div style="width: 550px;padding-left: 62px;">
              <button type="" class="btn btn-gray btn-hover-lightgray btn-sm" style="width: 62px;line-height: 1" name="submitcard">Submit</button>
              <div class="checkbox">
                <label>
                  <input type="checkbox"  name="accept">By checking this box, I agree to the Terms & Conditions & Privacy Policy.
                </label> 
              </div>
            </div>
           </form> 
